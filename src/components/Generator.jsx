...
import { WORKOUTS, SCHEMES } from '../utils/workout-list';
import { Button } from './Button';

function Header(props) {
  const { index, title, description } = props
  return (
    <div className='flex flex-col gap-4' style={{paddingTop: '5vh'}}>
...
export const Generator = (props) => {
  ...
  return (
    <SectionWrapper header={"generate your workout"} title={['It \'s', 'HUGE', 'o\'clock']}>
      ...
      <Header index={'02'} title={'Lock on targets'} description={'Select the muscle group you want'}/>
      ...
      <Header index={'03'} title={'Choose your goal'} description={'Select the training goal you want'}/>
